  ...
  return (
    ...
    >
      <button
        ...
        onClick={onClose}
      />
      <div className="relative max-h-[85dvh] w-full max-w-lg overflow-hidden rounded-t-2xl border border-neutral-200 bg-white shadow-xl sm:rounded-2xl">
        <div className="flex items-center justify-between border-b border-neutral-200 px-4 py-3">
          <h2 id="bookings-log-title" className="text-base font-semibold text-neutral-900">
            Saved bookings
          </h2>
          <button
            type="button"
            onClick={onClose}
            className="rounded-lg px-2 py-1 text-sm text-neutral-600 hover:bg-neutral-100 focus:outline-none focus-visible:ring-2 focus-visible:ring-neutral-400"
          >
            Close
          </button>
        </div>
        ...
        <div className="space-y-2 border-t border-neutral-200 bg-neutral-50/80 px-4 py-3">
          <input
            ref={fileInputRef}
            type="file"
