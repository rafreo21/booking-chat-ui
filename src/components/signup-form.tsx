...
export type RestaurantSignupFormProps = {
  className?: string
  title: string
  ...
  /** Email + Create Account sends magic link (may create user per Supabase settings). */
...
/**
 * signup-05 layout: email + Create Account, separator, Google OAuth.
 */
      ...
      <div>
        <FieldGroup>
          <div className="flex flex-col items-center gap-2 text-center">
            ...
            <FieldDescription className="text-center">{signinLink}</FieldDescription>
          </div>
          ...
          >
            <Field>
              <FieldLabel htmlFor="restaurant-signup-email">Email</FieldLabel>
              <Input
              ...
              {emailSent ? (
                <FieldDescription>
                  Check your inbox to confirm your account and finish signing up.
                </FieldDescription>
              ) : null}
            </Field>
            <Field>
