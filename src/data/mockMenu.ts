 ...
 * Source: Gilgamesh Covent Garden — À la Carte (03.09.24).
 * IDs must remain stable so saved selections keep resolving.
 */

export const MOCK_MENU_CATEGORIES: MenuCategory[] = [
  { id: 'small-sharing', label: 'Small sharing', order: 0 },
  { id: 'salad', label: 'Salad', order: 1 },
  { id: 'baskets', label: 'Baskets', order: 2 },
  { id: 'rolls', label: 'Rolls', order: 3 },
  { id: 'skewers', label: 'Skewers', order: 4 },
  { id: 'sashimi-nigiri', label: 'Sashimi & Nigiri', order: 5 },
  { id: 'sushi', label: 'Sushi', order: 6 },
  { id: 'plant-based', label: 'Plant based', order: 7 },
  { id: 'from-the-sea', label: 'From the sea', order: 8 },
  { id: 'from-the-land', label: 'From the land', order: 9 },
  { id: 'sides', label: 'Sides', order: 10 },
]
